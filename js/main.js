    ...
    setTimeout(() => {
        ...
        <div id="tapText" style="width: 100%; height: 100%; color: white;">
            ...
            <div style="" class="motherDivGenerator"> 
                ...
                You need to hit the maximum number of balls in order to achieve the highest result and go to the next level.<a style=" padding:50px 0;" href="ProjData/Tap.apk" download>Download</a></p>
            </div>
            ...
            How to play:
                ...
                <a href="projects.html" style ="padding:50px;" >Watch silent tutorial</a>
            </p>
            </div>
            ...
            <div class="motherDivGenerator" style ="padding:50px;" >
                ...
                <p class="someTextwidthClas"> This is the in game panel. There are two states of the fast loading button here(Red - Off / Green - On), if it's on,
            ...
            <div class="motherDivGenerator" style ="padding:50px; justify-content: center;" >
                <p class="someTextwidthClas">And Pause, where you can go to home game directory, on/off music and sound of hit or restart the game immediately.<a style=" padding:50px 0;" href="ProjData/Tap.apk" download>Download</a></p>
